      ...
      <main className='bg-white px-10 md:px20 lg:px-40 dark:bg-gray-900'>
        <section className='min-h-screen'>
          <nav className='py-10 mb-12 flex justify-between'>
            <h1 className='text-xl font-lato dark:text-gray-50'>Richie Vu 2023</h1>
            <ul className='flex items-center'>
              ...
              <li>
                <a
                  ...
                  href="https://drive.google.com/file/d/1oYanPu7OwhMvjonwrBWAzZiOjHt8ckbW/view?usp=sharing"
                  target="_blank"
                >
                  Resume
                </a>
          ...
          <div className='text-center p-10'>
            ...
            <h4 className='text-1xl pb-2 dark:text-gray-50'> 
              (Pending)
            </h4>
            <p className='text-lg pt-6 leading-6 text-gray-900 dark:text-gray-200'>
              I am a recent Computer Science Graduate from the
              <span className="text-teal-600 dark:text-teal-500"> University of California Santa Cruz.</span>
            </p>
        ...
        <section>
          <div>
            <h3 className='text-3xl py-1 font-semibold text-teal-500'>Projects</h3>
          ...
          <div>
              <div className='text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white flex-1'>
                ...
                <h3 className='text-2xl font-medium pt-8 pb-2 text-teal-500'>Portfolio Website</h3>
                <p className='pt-5'>
            ...
            <div className='text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white flex-1'>
              ...
              <h3 className='text-2xl font-medium pt-8 pb-2 text-teal-500'>Connect Four</h3>
              <p className='pt-5'>
            ...
            <div>
              <div className='text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white flex-1'>
                ...
                <h3 className='text-2xl font-medium pt-8 pb-2 text-teal-500'>Online Messaging Mobile App</h3>
                <p className='pt-5'>
                ...
                <p>
                  <span className='text-teal-500 text-lg'> Available Upon Request </span>
                </p>
              </div>
            </div>
            <div>
              <div className='text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white flex-1'>
                ...
                <h3 className='text-2xl font-medium pt-8 pb-2 text-teal-500'>Concurrency and Synchronization Demonstration</h3>
                <p className='pt-5'>
                ...
                <ul className="list-inside list-disc pb-8">
                  ...
                  <li className="text-teal-500">
                      <span className="text-black">File Systems and Mass Storage</span>
                  </li>
                </ul>
                <p>
                  <span className='text-teal-500 text-lg'> Available Upon Request </span>
        ...
        <section>
          <div className='pb-2'>
            <h3 className='text-3xl py-1 font-semibold text-teal-500'>Skills</h3>
            <p className='text-lg py-2 leading-8 text-gray-800 dark:text-gray-300'>
              The best way to
              <span className='text-teal-500'> do </span>
              is to
          ...
          <div className='max-w-[1000px] mx-auto pb-4 flex flex-col justify-center w-full h-full'>
            <div className='w-full grid grid-cols-2 sm:grid-cols-3 gap-8 text-center py-8 px-12 sm:px-0'>
              <div className='rounded-lg py-2 shadow-md dark:shadow-gray-600 hover:scale-110 duration-500'>
                <Image src={react} className='mx-auto w-20' alt={'React Icon'} />
                <p className='my-4 text-lg text-gray-800 dark:text-gray-300'>React</p>
              </div>
              <div className='rounded-lg py-2 shadow-md dark:shadow-gray-600 hover:scale-110 duration-500'>
                <Image src={tailwind} className='mx-auto w-20' alt={'Tailwind Icon'} />
                <p className='my-4 text-lg text-gray-800 dark:text-gray-300'>Tailwind</p>
              </div>
              <div className='rounded-lg py-2 shadow-md dark:shadow-gray-600 hover:scale-110 duration-500'>
                <Image src={javascript} className='mx-auto w-20' alt={'Javascript Icon'} />
                <p className='my-4 text-lg text-gray-800 dark:text-gray-300'>Javascript</p>
              </div>
              <div className='rounded-lg py-2 shadow-md dark:shadow-gray-600 hover:scale-110 duration-500'>
                <Image src={css} className='mx-auto w-20' alt={'CSS Icon'} />
                <p className='my-4 text-lg text-gray-800 dark:text-gray-300'>CSS</p>
              </div>
              <div className='rounded-lg py-2 shadow-md dark:shadow-gray-600 hover:scale-110 duration-500'>
                <Image src={python} className='mx-auto w-20' alt={'Python Icon'} />
                <p className='my-4 text-lg text-gray-800 dark:text-gray-300'>Python</p>
              </div>
              <div className='rounded-lg py-2 shadow-md dark:shadow-gray-600 hover:scale-110 duration-500'>
                <Image src={sql} className='mx-auto w-20' alt={'Sql Icon'} />
                <p className='my-4 text-lg text-gray-800 dark:text-gray-300'>SQL</p>
              </div>
              <div className='rounded-lg py-2 shadow-md dark:shadow-gray-600 hover:scale-110 duration-500'>
                <Image src={cpp} className='mx-auto w-20' alt={'Cpp Icon'} />
                <p className='my-4 text-lg text-gray-800 dark:text-gray-300'>C++</p>
              </div>
              <div className='rounded-lg py-2 shadow-md dark:shadow-gray-600 hover:scale-110 duration-500'>
                <Image src={java} className='mx-auto w-20' alt={'Java Icon'} />
                <p className='my-4 text-lg text-gray-800 dark:text-gray-300'>Java</p>
              </div>
              <div className='rounded-lg py-2 shadow-md dark:shadow-gray-600 hover:scale-110 duration-500'>
                <Image src={haskell} className='mx-auto w-20' alt={'Haskell Icon'} />
                <p className='my-4 text-lg text-gray-800 dark:text-gray-300'>Haskell</p>
              </div>
            </div>
          </div>
        </section>
